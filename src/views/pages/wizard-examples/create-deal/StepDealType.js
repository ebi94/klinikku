...
const data = [
  {
    ...
    value: "percentage",
    title: "Percentage",
    content: "Buat a deal which offer uses some % off (i.e 5% OFF) on total.",
  },
  {
    value: "flat-amount",
    title: "Flat Amount",
    content:
      "Buat a deal which offer uses flat $ off (i.e $5 OFF) on the total.",
  },
  {
    value: "prime-member",
    title: "Prime Member",
    content: "Buat prime member only deal to encourage the prime members.",
  },
];
const regionArray = [
  "Asia",
