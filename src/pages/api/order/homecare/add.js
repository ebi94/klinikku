...
export default function handler(req, res) {
  ...
  if (req.method === "POST") {
    const { pasien_id, complete_address, latitude, longitude, date } = req.body;

    if (!pasien_id || !complete_address || !latitude || !longitude || !date) {
      return res
        .status(400)
    ...
    const requestOptions = {
      method: "POST",
      url: `${baseUrl}api/mobile/booking-homecare/book`,
      headers,
      data: bodyReq,
      redirect: "follow",
    };
