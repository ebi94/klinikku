...
export default function handler(req, res) {
  ...
  if (req.method === "PUT") {
    ...
    const { status, reason, date, clinic_id, nurse_id } = req.body;
    ...
    const bodyReq = { status, reason, date, clinic_id, nurse_id };
    ...
    const requestOptions = {
      method: "PUT",
      url: `${baseUrl}api/backoffice/order-management/order-unit/update/${id}`,
      headers,
      data: bodyReq,
      redirect: "follow",
    };
