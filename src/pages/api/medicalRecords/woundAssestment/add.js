...
export default function handler(req, res) {
  ...
  if (req.method === "POST") {
    const { treatment_id, wound_assessment } = req.body;

    if (!treatment_id || !wound_assessment) {
      return res
        .status(400)
    ...
    const requestOptions = {
      method: "POST",
      url: `${baseUrl}api/backoffice/customers/medical-record/wound-assessment/create`,
      headers,
      data: bodyReq,
      redirect: "follow",
    };
