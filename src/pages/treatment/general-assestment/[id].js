...
const formSchema = yup.object({
  //   treatment_id: yup.string().required("Treatment ID harus diisi."),
  //   clinic_id: yup.string().required("Clinic ID harus diisi."),
  //   is_new: yup.boolean().required("Status baru harus diisi."),
  date: yup
    .date()
    .required("Tanggal harus diisi.")
    .typeError("Format tanggal harus YYYY-MM-DD"),
...
const FormGeneralAssestment = () => {
  ...
  const defaultValues = {
    date: "", // Format YYYY-MM-DD, make sure to handle date object or string based on your date picker component
    main_complaint: "",
    history_of_injury: "",
    concomitant_disease: [], // Start with an empty array since it's a list of strings
    nutrition: {
      appetite: "", // Default could be one of the valid options or empty
      frequency_of_eating: "", // Default could be one of the valid options or empty
      eating_pattern: "", // Default could be one of the valid options or empty
    },
    physical_condition: {
      way_of_walking: "",
      weight: "", // Ensure this is a string or number depending on how you handle inputs
      height: "", // Ensure this is a string or number depending on how you handle inputs
      konjungtiva: "",
    },
    triage: {
      blood_pressure: "",
      pulse_frequency: "", // Make sure to handle as string if needed for display
      body_temperature: "",
      breathing_frequency: "",
      consciousness: "",
    },
    gds: {
      data: "",
      date: "", // Format YYYY-MM-DD HH:mm, ensure handling of date-time
      moment: "",
    },
  };
